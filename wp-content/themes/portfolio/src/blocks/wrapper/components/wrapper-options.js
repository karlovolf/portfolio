...
export const WrapperOptions = ({ attributes, actions }) => {
  ...
  return (
    <Fragment>
      {!wrapperDisable &&
        <PanelBody title={__('Wrapper Responsive Layout', 'portfolio')} initialOpen={false}>

          {(onChangeWrapperUse && wrapperUseShowControl) &&
            <ToggleControl
              label={wrapperUse ? __('Wrapper Enabled', 'portfolio') : __('Wrapper Disabled', 'portfolio')}
              help={__('Toggle wrapper options on/off.', 'portfolio')}
              checked={wrapperUse}
          ...
          {(onChangeWrapperUseSimple && wrapperUse && wrapperUseSimpleShowControl) &&
            <ToggleControl
              label={wrapperUseSimple ? __('Wrapper Simple Enabled', 'portfolio') : __('Wrapper Simple Disabled', 'portfolio')}
              help={__('Toggle wrapper Simple options on/off.', 'portfolio')}
                ...
                {(tab) => (
                  <Fragment>
                    {tab.name === 'large' && (
                      <Fragment>
                        <br />
                        <strong className="notice-title">{__('Large Layout Options', 'portfolio')}</strong>
                        <p>{__('This options will only control large screens options.', 'portfolio')}</p>
                        <br />
                    ...
                    {tab.name === 'desktop' && (
                      <Fragment>
                        <br />
                        <strong className="notice-title">{__('Desktop Layout Options', 'portfolio')}</strong>
                        <p>{__('This options will only control desktop screens options. If nothing is set, parent options will be used.', 'portfolio')}</p>
                        <br />
                        <WrapperResponsiveTabContent
                          type={'desktop'}
                          useSimple={wrapperUseSimple}
                    ...
                    {tab.name === 'tablet' && (
                      <Fragment>
                        <br />
                        <strong className="notice-title">{__('Tablet Layout Options', 'portfolio')}</strong>
                        <p>{__('This options will only control tablet screens options. If nothing is set, parent options will be used.', 'portfolio')}</p>
                        <br />
                        <WrapperResponsiveTabContent
                          type={'tablet'}
                          useSimple={wrapperUseSimple}
                    ...
                    {tab.name === 'mobile' && (
                      <Fragment>
                        <br />
                        <strong className="notice-title ">{__('Mobile Layout Options', 'portfolio')}</strong>
                        <p>{__('This options will only control mobile screens options. If nothing is set, parent options will be used.', 'portfolio')}</p>
                        <br />
                        <WrapperResponsiveTabContent
                          type={'mobile'}
                          useSimple={wrapperUseSimple}
                ...
                <ColorPaletteCustom
                  label={
                    <Fragment>
                      ...
                      {__('Background Color', 'portfolio')}
                    </Fragment>
                  }
                  help={__('Change Block Background color. Block spacing will be included in block background color.', 'portfolio')}
              ...
              {onChangeWrapperId &&
                <TextControl
                  label={
                    <Fragment>
                      <Icon icon={icons.id} />
                      {__('Block ID', 'portfolio')}
                    </Fragment>
                  }
                  help={__('Add Unique ID to the block.', 'portfolio')}
                  value={wrapperId}
